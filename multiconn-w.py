...
class Alg():
    def __init__(self):
        ...
        #self.red_weights = [3.0,1.0,1.0]
        self.red_weights = [3.0,2.0,1.0]
        self.blue_weights = [0.5,0.5,0.5,0.5,0.5,0.5,0.5]
...
if __name__ == '__main__':
    ...
    plt.xlabel('Monitor')
    plt.plot(red_plot_list, color='red', label='MultiConn-W: '+str(alg.red_weights[0])+','+str(alg.red_weights[1])+','+str(alg.red_weights[2]))
    plt.legend(loc='lower right')
    plt.savefig('MultiConn-W-'+str(alg.red_weights[0])+'-'+str(alg.red_weights[1])+'-'+str(alg.red_weights[2])+'-4000.png', bbox_inches='tight')
    ...
    plt.plot(red_plot_list, color='red', label='MultiConn-W: '+str(alg.red_weights[0])+','+str(alg.red_weights[1])+','+str(alg.red_weights[2]))
    plt.legend(loc='lower right')
    plt.savefig('MultiConn-W-'+str(alg.red_weights[0])+'-'+str(alg.red_weights[1])+'-'+str(alg.red_weights[2])+'-250.png', bbox_inches='tight')
