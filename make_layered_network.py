...
def main():
    ...
    R1_org = nx.read_gexf('./layers/Knowledge.gexf')
    R2_org = nx.read_gexf('./layers/TRUST.gexf')
    R3_org = nx.read_gexf('./layers/LOC.gexf')
    ...
    B1 = nx.read_gexf('./layers/Knowledge.gexf')
    ...
    B2 = nx.read_gexf('./layers/TRUST.gexf')
    ...
    B3 = nx.read_gexf('./layers/LOC.gexf')
    ...
    B4 = nx.read_gexf('./layers/NoordinTop.gexf')
    ...
    B7 = nx.read_edgelist("./layers/fb.txt",create_using = nx.Graph(),nodetype = int)
...
def gen_gexf(g,g_name):
    nx.write_gexf(g, './networks_new/' + g_name + '.gexf')
